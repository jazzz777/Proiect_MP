...
namespace Stiri.Migrations
{
    ...
    [Migration("20230108145259_categorii_plus")]
    partial class categorii_plus
    {
            ...
            modelBuilder.Entity("Stiri.Models.Articole_Jurnalist", b =>
                {
                    ...
                    b.HasOne("Stiri.Models.Jurnalist", "Jurnalisti")
            ...
            modelBuilder.Entity("Stiri.Models.Categorii_Articole", b =>
                {
                    ...
                    b.HasOne("Stiri.Models.Categorie", "Categorii")
                        .WithMany("Categorii_Articole")
                        .HasForeignKey("CategorieID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
